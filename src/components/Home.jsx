...
const Home = forwardRef((props,ref) => {
    ...
    return(
        ...
        <section ref={ref[1]} className="home-small">
            <div className="home-left-section">
                <h1 className="phrase" ><span className='phrase-text'>IT'S JUST A LINE OF CODE</span></h1>
                <article className="presentation" ><span className='presentation-text'>
                ...
                <h2 className="rol" ><span className='rol-text'>BY A SOFTWARE DEVELOPER</span></h2>
            </div>
        </section>
        </>
